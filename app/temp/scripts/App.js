	...
	_createClass(RevealOnScroll, [{
		...
		value: function createWaypoints() {
			...
			this.itemsToReveal.each(function () {
				var currentItem = this; //cannot assign this to element in the new instance of the Waypoint object - this will then refer to the object, rather than the element we wanted ot target
				new Waypoint({
					element: currentItem,
